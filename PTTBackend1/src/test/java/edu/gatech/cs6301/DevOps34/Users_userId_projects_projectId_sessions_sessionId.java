...
public class Users_userId_projects_projectId_sessions_sessionId {
    ...
    //CHANGES: No GET Method for /sessions/{sessionId}. Should return 405
	@Test
	public void GETmethodError405() throws Exception {
		try {
    ...
    //CHANGES: No DELETE Method for /sessions/{sessionId}. Should return 405
	@Test
	public void DELETEmethodError405() throws Exception {
		try {
